...
class FactsApi(object):
    ...
    def updateinterface(self, **kwargs):  # noqa: E501
        """Updating interface endpoints  # noqa: E501

        Updates an interface's endpoints. Does not allowing updating of the interface name. #### Example We create an interface. ~~~ POST /createinterface {     ...     \"addData\": {\"url\": \"https://acme.com/add\"},     \"getData\": {\"url\": \"https://acme.com/get\"},     \"deleteData\": {\"url\": \"https://acme.com/delete\"},     \"name\": \"BulkStorageInterface\"     ... } ~~~ and then later change the \"getData\" endpoint to use GET ~~~ POST /updateinterface {     \"nodeId\": \"BulkStorageInterface\",     \"getData\": {         \"url\": \"https://acme.com/get\",         \"method\": \"GET\"     } } ~~~  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.updateinterface(async=True)
        >>> result = thread.get()

        :param async bool
        :param str login:
        :param str representing:
        :param UpdateInterfaceRequest update_interface_request:
        :return: CreateInterfaceResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.updateinterface_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.updateinterface_with_http_info(**kwargs)  # noqa: E501
            return data

    def updateinterface_with_http_info(self, **kwargs):  # noqa: E501
        """Updating interface endpoints  # noqa: E501

        Updates an interface's endpoints. Does not allowing updating of the interface name. #### Example We create an interface. ~~~ POST /createinterface {     ...     \"addData\": {\"url\": \"https://acme.com/add\"},     \"getData\": {\"url\": \"https://acme.com/get\"},     \"deleteData\": {\"url\": \"https://acme.com/delete\"},     \"name\": \"BulkStorageInterface\"     ... } ~~~ and then later change the \"getData\" endpoint to use GET ~~~ POST /updateinterface {     \"nodeId\": \"BulkStorageInterface\",     \"getData\": {         \"url\": \"https://acme.com/get\",         \"method\": \"GET\"     } } ~~~  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.updateinterface_with_http_info(async=True)
        >>> result = thread.get()
        ...
        all_params = ['login', 'representing', 'update_interface_request']  # noqa: E501
        all_params.append('async')
        all_params.append('body')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
